...
SERVICES = [
    dict(category="printing", name="Premium Business Cards (Pack of 100)", short="Matte or gloss finish, full colour, thick 350gsm stock.", price=25.00, unit="pack", featured=True, image="img/services/business-cards-sample.jpg"),
    ...
    dict(category="branding", name="Logo Design Package", short="3 concepts, 2 revisions, full source files.", price=150.00, unit="project", featured=True, image="img/services/graphic-design-workspace.jpg"),
    ...
    dict(category="branding", name="Custom Branded Polo Shirts & Apparel", short="Embroidered or printed logos on polos, uniforms & workwear.", price=12.00, unit="shirt", featured=True, image="img/services/branded-polo-black.jpg"),
    dict(category="branding", name="Event Flyer & Programme Design", short="Eye-catching flyers, invites, and event programmes, print-ready.", price=40.00, unit="project", image="img/services/event-flyer-design.jpg"),
    ...
    dict(category="photo-video", name="Event Video Coverage (Half Day)", short="Full crew, edited highlight reel included.", price=350.00, unit="event", bookable=True, featured=True, image="img/services/video-camera-rig.jpg"),
    ...
    with app.app_context():
        ...
        for s in SERVICES:
            svc = Service(
                ...
                price=s["price"],
                unit=s["unit"],
                image=s.get("image", "img/placeholder-service.jpg"),
